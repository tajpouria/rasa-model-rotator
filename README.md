...
- `IGNORE_FILE_PATHS`: A list of `comma-separated` extra file paths that must be ignored for deletion. `LATEST_MODEL_PATH` will be ignore all the time. default: "models/lost+found".
